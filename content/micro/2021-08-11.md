...
People have come to expect a repository's source code to guide them through the
contribution process. That job belongs to documentation and developer guides.

Comments are for the people writing the code, not necessarily the peanut
